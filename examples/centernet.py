...
def test_centernet():
    img_path = 'examples/demo.jpg'
    prototxt = 'output/centernet_rs18.prototxt'
    caffemodel = 'output/centernet_rs18.caffemodel'
    ...
    im = load_norm(img)
    net.blobs['input'].data[...] = im
    
    ## infer
    out = net.forward()
    
    ih, iw = im.shape[-2:]
    bboxes, classes = postprocess(ih, iw, out['dets'], out['labels'], out['262'])
